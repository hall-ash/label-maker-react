...
const SettingsModal = ({ isOpen, toggle }) => {
  ...
  //     if (savedSettings) {
  //       const newSavedSettings = Object.keys(defaultSettings).reduce((acc, setting) => {
  //         const validSetting = savedSettings[setting] !== undefined && savedSettings[setting] !== "";
  //         acc[setting] = validSetting ? savedSettings[setting] : defaultSettings[setting];
  //         return acc;
  //       }, {});
  //       setSettings(newSavedSettings);
  //     } else {
